        ...
        return {
          ...
          link: function (scope, element, attrs, ctrl) {
            ...
            callbacks.dragStop = function (event) {
					var scope = event.dest.nodesScope;
					...
					// что переносим
					var current_node_cope = nodeScope.$modelValue;
					// куда переносим
					//var parent_node_cope = nodeScope.$parentNodeScope.$modelValue;
					
					if (scope.node)
							current_node_cope.pdi = scope.node.id
					else
							current_node_cope.pdi = 0;
					
					//current_node_cope.pdi = parent_node_cope.id;
					
					angular.forEach(scope.$modelValue,function(value,index){
							value.sort = index;
					})
